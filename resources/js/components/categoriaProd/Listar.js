...
const Listar = () => {
    const [metodo, setMetodo] = useState(new Service("categorias"));
                ...
                actions={[
                    {
                        ...
                        onClick: (event, rowData) => abrirModal(rowData.catp_id)
                    },
                    {
                        icon: "delete",
                        tooltip: "Eliminar Categoria",
                        onClick: (event, rowData) => eliminar(rowData.catp_id)
                    }
                ]}
                options={{
