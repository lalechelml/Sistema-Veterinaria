                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-group clear-list m-t">
                        <li class="list-group-item fist-item">
                            ...
                            <span class="label label-success">1</span> Please
                            contact me
                        </li>
                        <li class="list-group-item">
                            <span class="float-right"> 10:16 am </span>
                            <span class="label label-info">2</span> Sign a
                            contract
                        </li>
                        <li class="list-group-item">
                            <span class="float-right"> 08:22 pm </span>
                            <span class="label label-primary">3</span> Open new
                            shop
                        </li>
                        <li class="list-group-item">
                            <span class="float-right"> 11:06 pm </span>
                            <span class="label label-default">4</span> Call back
                            to Sylvia
                        </li>
                        <li class="list-group-item">
                            <span class="float-right"> 12:00 am </span>
                            <span class="label label-primary">5</span> Write a
                            letter to Sandra
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content ibox-heading">
                                        ...
                                        <small>
                                            ...
                                            Meeting is on 6:00am. Check your
                                            schedule to see detail.
                                        </small>
                                    </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="row">
                                                ...
                                                <div class="col content no-top-border">
                                                    ...
                                                    <p>
                                                        Conference on the sales
                                                        results for the previous
                                                        year. Monica please
                                                        examine sales trends in
                                        ...
                                        <div class="timeline-item">
                                            <div class="row">
                                                ...
                                                <div class="col content">
                                                    ...
                                                    <p>
                                                        Go to shop and find some
                                                        products. Lorem Ipsum is
                                        ...
                                        <div class="timeline-item">
                                            <div class="row">
                                                ...
                                                <div class="col content">
                                                    <p class="m-b-xs">
                                                        <strong>
                                                            Chat with Monica and
                                                            Sandra
                                                        </strong>
                                                    </p>
                                                    <p>
                                                        Web sites still in their
                                                        infancy. Various
